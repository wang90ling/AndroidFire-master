...
public class PtrEasyRecyclerView extends FrameLayout {
    public static final String TAG = "PtrEasyRecyclerView";
    ...
    protected PtrHandler mRefreshListener;
    ...
    public PtrEasyRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initView();
    }

    public PtrEasyRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initView() {
        ...
        //生成主View
        View v = LayoutInflater.from(getContext()).inflate(R.layout.layout_progress_ptr_recyclerview, this);
        ...
        initRecyclerView(v);
        setDefautifalPtrSetting();
    }


    public void setDefautifalPtrSetting(){
    ...
    private static class EasyDataObserver extends AdapterDataObserver {
        private PtrEasyRecyclerView recyclerView;
        private boolean isInitialized = false;
        private boolean hasProgress = false;

        public EasyDataObserver(PtrEasyRecyclerView recyclerView, boolean hasProgress) {
    ...
    public void setRefreshListener(PtrHandler listener) {
        mPtrLayout.setEnabled(true);
        mPtrLayout.setPtrHandler(listener);
    ...
    public void setRefreshing(final boolean isRefreshing){
        mPtrLayout.post(new Runnable() {
            @Override
            public void run() {
                mPtrLayout.setPullToRefresh(isRefreshing);
            }
        });
    }
        ...
        mPtrLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                if (isRefreshing&&isCallbackListener&&mRefreshListener!=null){
                    mRefreshListener.onRefreshBegin(mPtrLayout);
                }
            }
        });
    }
