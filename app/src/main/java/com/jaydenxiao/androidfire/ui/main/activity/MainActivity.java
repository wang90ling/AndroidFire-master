...
import com.jaydenxiao.androidfire.ui.main.fragment.PersonalCenterFragment;
...
public class MainActivity extends BaseActivity {
    ...
    private String[] mTitles = {"首页", "美女","视频","关注","我的"};
...
//        UpdateKey.DialogOrNotification=UpdateKey.WITH_DIALOG;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRxManager.on(AppConstant.MENU_SHOW_HIDE, new Action1<Boolean>() {
            ...
            public void call(Boolean hideOrShow) {
                //startAnimation(hideOrShow);  //这个方法中是显示和隐藏底部的Tab菜单功能的方法
            }
        });
    }
    /**
    ...
    private void initFragment(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            personalCenterFragment = (PersonalCenterFragment) getSupportFragmentManager().findFragmentByTag("personalCenterFragment");
            ...
            transaction.add(R.id.fl_body, personalCenterFragment, "personalCenterFragment");
        }
        transaction.commit();
